<template>
  <footer class="py-5 text-center bg-dark">
    <div class="h4c-footer pt-5 pb-3">
      ...
      <div id="h4c-fb" class="h4c-social d-inline mr-5"><a href="https://www.facebook.com/techoregonswv/" target="_blank"><i class="fa fa-facebook fa-3" aria-hidden="true"/></a></div>
