    ...
    <section id="h4c-challenges-2018" class="text-center bg-light py-5">
        <div class="container">
            <div class="h4c--header">
                <p id="h4c-challenge-title" class="h4c--title">2018 CHALLENGES</p>
            </div>
            <div id="h4c-challenge-description">
                <p id="h4c-challenge-description" class="lead">
                    ...
                    <br> + Transformation for the public good, powered by fiber and you.
                </p>
            </div>
            <div id="h4c-challenge-button">
                <router-link class="btn btn-sm btn--h4c btn--h4c-outline" to="/challenges-2018">
