    ...
    <div class="row align-items-center h4c-sponsors">
      <div class="col text-center">
        <figure class="blocks-gallery-image">
          <img src="~/assets/images/sponsors/XS-Media-Logo-Horizontal-Lite-Black-e1516088037343.png" alt="" data-id="256" >
        </figure>
      </div>
      <div class="col text-center">
        <figure class="blocks-gallery-image">
          <img src="~/assets/images/sponsors/UOSignature-STK-3435-CGY11-4C-e1516088359647.jpg" alt="" data-id="162" >
        </figure>
      </div>
      <div class="col text-center">
        <figure class="blocks-gallery-image">
          <img src="~/assets/images/sponsors/Lane-Workforce-Partnership-e1516088135700.png" alt="" data-id="505" >
        </figure>
      </div>
    </div>
    <div class="row align-items-center h4c-sponsors">
      <div class="col text-center">
        <figure class="blocks-gallery-image">
          <img src="~/assets/images/sponsors/idx.png" alt="" data-id="252">
        </figure>
      </div>
      <div class="col text-center">
        <figure class="blocks-gallery-image">
          <img src="~/assets/images/sponsors/CBTN-logo-500-e1516088053650.png" alt="" data-id="503">
        </figure>
      </div>
      <div class="col text-center">
        <figure class="blocks-gallery-image">
